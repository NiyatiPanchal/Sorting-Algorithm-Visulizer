    ...
    <div className="sidebar">
      ...
      <div className="sidebar__option">
        ...
        <select
          ...
          disabled={myState.play ? true : false}
        >
          {/* <option value="#2B3856">Dark Slate</option> */}
          <option value="#151B54">Night Blue</option>
          <option value="#CD7F32">Bronze</option>
          <option value="#3D3635">Gray Brown</option>
          <option value="#9E7BFF">Purple Mimosa</option>
        </select>
      </div>
